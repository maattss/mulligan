...
const emit = defineEmits<{
  (event: 'toggle', playerId: string): void
  (event: 'player-deleted', playerId: string): void
  (event: 'player-added', player: PlayerProfile): void
}>()
